...
import { projectData } from "@/lib/mock-data";
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span className={cn(
                ...
                project.status === "In Progress" ? "text-blue-500 bg-blue-50 dark:bg-blue-500/10" : "text-muted-foreground bg-muted"
              )}>
                {project.status}
              </span>
            </div>
            <p className="text-xs text-muted-foreground mb-3">{project.website} &middot; {project.type}</p>
            <div className="mb-2">
